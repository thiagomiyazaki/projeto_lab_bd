...
-- CREATING TABLES usuario

CREATE TABLE usuario (
    id INTEGER AUTO_INCREMENT,
    nome VARCHAR(128) NOT NULL COMMENT 'Nome do usuario. Deve ter no maximo 128 caracteres',
    email VARCHAR(128) UNIQUE COMMENT 'Email do usuario',
    data_cadastro DATE,
    idade INTEGER COMMENT 'Idade do usuario',
    PRIMARY KEY (id)
) COMMENT = 'Esta tabela armazena os usuarios do sistema';

-- TRANSFORMA CO_ENTIDADE EM CHAVE PRIMÁRIO E NOT NULL

ALTER TABLE escola
MODIFY CO_ENTIDADE INTEGER NOT NULL,
ADD PRIMARY KEY (CO_ENTIDADE);

-- CRIA TABELA BOOKMARK

CREATE TABLE bookmark (
	id INTEGER AUTO_INCREMENT,
	id_usuario INTEGER COMMENT 'id do usuario da tabela de usuarios',
    id_escola INTEGER COMMENT 'id da escola da tabela de escolas',
    PRIMARY KEY (id),
    FOREIGN KEY (id_usuario) REFERENCES usuario(id),
    FOREIGN KEY (id_escola) REFERENCES escola(CO_ENTIDADE)
) COMMENT = 'Esta tabela faz a associacao entre usuarios e escolas';

-- TRANSFORMAR ID_TURMA EM NOT NULL E DEPOIS CHAVE PRIMARIA

ALTER TABLE turma
MODIFY ID_TURMA INTEGER NOT NULL,
ADD PRIMARY KEY (ID_TURMA);

-- CRIAR CHAVE PRIMARIA EM DOCENTE

ALTER TABLE docente
ADD PRIMARY KEY (CO_PESSOA_FISICA, ID_TURMA);

-- CRIAR CHAVE PRIMARIA EM MATRICULA

ALTER TABLE matricula
MODIFY ID_MATRICULA INTEGER NOT NULL,
ADD PRIMARY KEY (ID_MATRICULA);

-- Modificar campo data de cadastro da tabela usuario para aceitar como default a data atual

ALTER TABLE usuario
MODIFY COLUMN data_cadastro DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT 'Data em que foi cadastrado';

-- Adicione o campo senha na tabela Usuario, com valor default de sha(‘senha’) e de até 40 caracteres

SELECT SHA1('senha');
ALTER TABLE usuario
ADD COLUMN senha VARCHAR(40) DEFAULT '7751a23fa55170a57e90374df13a3ab78efe0e99' COMMENT 'Senha do Usuario';

-- Adicione o campo data de nascimento na tabela Usuario;

ALTER TABLE usuario
ADD COLUMN data_nascimento DATE COMMENT 'Data de nascimento do usuario';

-- Inserir ao menos um registro manualmente nas tabelas Usuario e Bookmark

INSERT INTO usuario (nome, email, idade, senha, data_nascimento)
VALUES ('Thiago Miyazaki', 'miyathiago@gmail.com', 35, SHA1('batatinha'), '1988-09-05');

INSERT INTO bookmark (id_usuario, id_escola)
VALUES (1, 35004193);

-- Atualizar o valor de algum atributo;
...
-- Adicionar um novo campo/alterar o tipo de um campo;

ALTER TABLE usuario
ADD COLUMN descricao TEXT COMMENT 'Informacoes adicionais sobre o usuario';

-- Adicionar documentação sobre a tabela;
